# include "ass5_14CS10008_translator.h"
# include "y.tab.h"
# include <string.h>
# include <stdlib.h>
# include <stdio.h>
...
symbol_table_fields::symbol_table_fields(char *name_f, tNode *Type_f, void *initial_value_f, int size_f, int offset_f, symbolTable *nestedTable_f) : name(name_f), Type(Type_f), initial_value(initial_value_f), size(size_f), offset(offset_f), nestedTable(nestedTable_f) {}
